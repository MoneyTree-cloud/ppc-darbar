...
<div class="overlay" id="overlay" style="display: none">
          <div class="form-container" style="max-width: 600px; width: 100%; flex-direction: column;">
            ...
            <form action="" method="post" class="lead_form">
              ...
              <div class="form-group">
                <input type="tel" name="mobile" id="phoneInput" required minlength="10" maxlength="10" pattern="[6-9][0-9]{9}" title="Please enter a valid 10-digit Indian mobile number"/>
