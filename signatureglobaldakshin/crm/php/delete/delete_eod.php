...
try {
    ...
    if ($stmt->affected_rows > 0) {
        ...
        header("Location: ../../eod_report.php?type=success&message=$employ_id Data Deleted Successfully!!");
    } else {
        // Redirect back with error message
        header("Location: ../../eod_report.php?type=error&message=Something Went Wrong!!");
    }
