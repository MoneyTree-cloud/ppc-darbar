  ...
  <div class="container">
    ...
    <div class="main">
      ...
      <?php include('components/lead_details.php'); ?>
        ...
        <!-- Include the popup file at the bottom of your page -->
        <?php include 'components/upload_leads_form.php'; ?>
        ...
        <div class="recentOrders">
          <div class="cardHeader">
            ...
            <td style="background: transparent; align-content: flex-end;">
              ...
              <!-- <div class="dropdown">
                    <button type="button" class="btn" onclick="toggleDropdown('teamExportDropdown')">Raw Leads ▾</button>
                ...
                <a href="assets/uploaded_leads_template.xlsx" download
                   class="custom-file-upload">
                   <ion-icon name="download-outline"></ion-icon> Download Template
                </a>


               <button onclick="openUploadPopup()" class="btn">Upload</button>

                <script>
                    const fileInput = document.getElementById('excel_file');
                    const fileChosen = document.getElementById('file-chosen');
                    const uploadForm = document.querySelector('form'); // form select karo
                    ...
                    uploadForm.addEventListener('submit', function (e) {
                        if (!fileInput.value) {
                            ...
                            // notificationMessage('error', 'Please select file first to upload new leads');
                            // notificationMessage("error", "Please select file first to upload new leads");
                        } else {
                            // notificationMessage("processing", "Your file is getting uploaded, Please wait..");
                            notificationMessage('processing', 'Your file is getting uploaded, Please wait..');
                        }
                    });
                </script>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('submit', '.lead_form', function(e) {
            ...
            $.ajax({
                url: 'php/update_uploaded_lead.php',
                method: 'POST',
                data: formData,
                dataType: 'json',
    ...
    function fetchLeads() {
        ...
        $.ajax({
            url: 'php/fetch_uploaded_leads.php',
            method: 'GET',
            data: {
    ...
    function exportToExcel() {
        ...
        form.method = 'POST';
        form.action = 'php/export_uploaded_leads.php';
